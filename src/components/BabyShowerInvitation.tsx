  ...
  return (
    <div className="max-w-4xl w-full mx-auto rounded-lg flex flex-col items-center">
      ...
      <div className="relative w-full text-center px-4 sm:px-6 md:px-8 py-4 flex flex-col items-center">
        ...
        {/* Content centered within the floral border - moved further down from the ribbon */}
        <div className="relative z-10 max-w-xs sm:max-w-sm md:max-w-md mx-auto mt-28 sm:mt-36 md:mt-40">
